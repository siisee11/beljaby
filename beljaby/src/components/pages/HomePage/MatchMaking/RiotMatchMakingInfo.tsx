    ...
    <>
        <animated.div style={fade}>        
          <div className="RiotMatchMakingInfo">
                ...
                return (
                  <div className="player">
                    ...
                    <img src={localInfo[2]} alt="base"
                        style={{width:"80px", height:"80px", margin:"30px 0px 0px -40px", zIndex:2}} 
                    />
                  </div>
                )
              })
            ...
            <Title level={3} style={{alignSelf:"center", margin: "50px"}}> Win Persentage : {Math.round(wps[0])} </Title>
          ...
          <div className="RiotMatchMakingInfo__team">
            ...
            <Title level={3} style={{alignSelf:"center", margin: "50px"}}> Win Persentage : {Math.round(wps[1])} </Title>
          </div>
        </div >
        <Button
          onClick={onFinish}
